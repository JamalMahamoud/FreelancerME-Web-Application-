...
--
-- Host: localhost
-- Generation Time: Dec 15, 2020 at 03:30 PM
...
(30, 20, 'jamal', 'jamal\'sss', 'fff', 'approve', '2020-12-10');
...
(29, 'admin', '$2y$10$krgudvhstfgeilvgsteo6uL9v7fc.g6BvAtqho4rL4UL94uffnl0m', 'Admin', 'Admin', 'ddd@GMail.com', 'admin', '$2y$10$krgudvhstfgeilvgsteo67'),
...
(34, 'monab12', '$2y$10$krgudvhstfgeilvgsteo6uiEm6vBsnQXyerazvmO6K0FBu3201yF2', 'Monab', 'Pool', 'monan@ui.com', 'customer', '$2y$10$krgudvhstfgeilvgsteo67'),
(35, 'demo', '$2y$10$krgudvhstfgeilvgsteo6ues0zLqQR5P51tyxosfO0F1i/LDJamsW', 'Monab', 'Montana', 'sss@ff.com', 'customer', '$2y$10$krgudvhstfgeilvgsteo67'),
(37, 'mon2', '$2y$10$krgudvhstfgeilvgsteo6uNHNkApt1XGbaxzBPbd/wDLEQsctYtj6', 'Monab', 'Montan', 's@gmail.com', 'customer', '$2y$10$krgudvhstfgeilvgsteo67'),
(38, 'bright', '$2y$10$krgudvhstfgeilvgsteo6uq9RNHfYnIV32SbiVk5mMOlgknTBk0le', 'Bright', '  Adjey', 'bright@gmail.com', '    admin ', '$2y$10$krgudvhstfgeilvgsteo67');
...
--
ALTER TABLE `Booking`
  MODIFY `Bookind_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `jobseeker`
  MODIFY `jobseeker_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
